...
from model.concat import PoseEstimator
...
train_dataset = PoseDataset(ROOT_DIR, 'image_train', 'joint_train')
valid_dataset = PoseDataset(ROOT_DIR, 'image_test', 'joint_test')
